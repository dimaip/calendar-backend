    ...
    protected function getDayData($perehod, $lang)
    {
        ...
        foreach ($airtableData as $line) {
            ...
            $groups = [
                ...
                'vespers' => ['Стихиры на Господи взываю', 'Стихиры на стихах', 'Прокимен вечерни', 'Прокимен триоди 1', 'Прокимен триоди 2'],
                'matins' => ['Стихиры на хвалите', 'Стихиры после 50 псалма', 'Прокимен утрени', 'Степенны']
            ];
